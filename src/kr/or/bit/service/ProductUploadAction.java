...
public class ProductUploadAction implements Action {
	...
	public ActionForward execute(HttpServletRequest request, HttpServletResponse response) {
		...
		dao.productUpload(storename, subj, b_num, addr, price, content);
		...
		try {
			...
			for (int i = 0 ; i < imgs.length; i++) {
				...
				boolean b = dao.productImgUpload(imgs[i], p_num, i+1);
			}
			...
			//boolean result = dao.productUpload(imgs, storename, subj, b_num, addr, price, content);
...
//				msg = "등록 성공!";
//			} else {
//				url = "WEB-INF/views/mysell/mysell.jsp";
//				icon = "error";
//				msg = "등록 실패..";
//			}
