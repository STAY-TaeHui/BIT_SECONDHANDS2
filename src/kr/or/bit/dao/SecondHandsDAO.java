...
//		         System.out.println(obj.toString());
	...
	*/
	...
	//상품 등록 -영훈-
	public JSONObject mySell(String img_name, String subj, String t_num, String m_num, String b_num, String addr,
			String status, String price, String content) {
		Connection conn = null;
		PreparedStatement pstmt = null;
		ResultSet rs=null;
	    JSONObject obj = new JSONObject();
	    ...
	    try {
	    	conn=ds.getConnection();
	         ...
	         sql += "insert into product(pimg_name, p_subj, t_num, m_num, b_num, p_addr, p_status, p_price, p_content) values(?,?,?,?,?,?,?,?,?)";
	         pstmt = conn.prepareStatement(sql);
	         pstmt.setString(1, img_name);
			 pstmt.setString(2, subj);
			 pstmt.setString(3, t_num);
			 pstmt.setString(4, m_num);
			 pstmt.setString(5, b_num);
