		...
		<div class="inner-header">
			...
			<div class="row">
				...
				<div class="col-lg-7 col-md-7">
					...
					<div class="advanced-search">
						...
						<div class="input-group" id="header_search">
							...
							<button type="submit" name="clickbtn" onclick="search()">
								<i class="ti-search"></i>
							</button>
						</div>
						<!-- </form> -->
				...
				<div class="col-lg-3 text-right col-md-3">
					<!--  -->
					<ul class="nav-right">
						<li class="heart-icon"><c:choose>
								<c:when test="${sessionScope.storename eq null}">
									<a href="login.do"> <img src="img/sell.gif">
									</a>
								</c:when>
								<c:otherwise>
									<a href="#?storename=" ${sessionScope.storename}> <img
										src="img/sell.gif">
									</a>
								</c:otherwise>
							</c:choose></li>
						<li class="cart-icon"><c:choose>
								<c:when test="${sessionScope.storename eq null}">
									<a href="login.do"> <img src="img/myshop.gif">
									</a>
								</c:when>
								<c:otherwise>
									<a href="myshop.do?storename=${sessionScope.storename}"> <img
										src="img/myshop.gif">
									</a>
								</c:otherwise>
							</c:choose></li>
...
<<<<<<< HEAD
						...
						</select> <select id="middle" onchange="getcategorybottom()"
							class="c_selection">
							<option>중분류</option>
