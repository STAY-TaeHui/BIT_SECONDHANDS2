	...
	function setcategorytop() {
		...
		$.ajax({
			...
			success : function(responsedata) {
				...
				$('#top_t').val(${product.t_num}).prop("selected",true);
				setcategorymiddle();
	...
	function setcategorymiddle() {
		...
		$.ajax({
			...
			success : function(responsedata) {
				...
				$('#middle_m').val(${product.m_num}).prop("selected",true);
				console.log(${product.m_num});
	...
	function setcategorybottom() {
		...
		$.ajax({
			...
			success : function(responsedata) {
				...
				console.log(${product.b_num});
				$('#bottom_b').val(${product.b_num}).prop("selected",true);
...
<body>
	<div id="fullwrap">
		...
		<div id="bodywrap">
			<form action="producteditok.manage" id="frm" method="post"  enctype="multipart/form-data">
            ...
            <hr>
				...
				<div class="form-group row">
					...
					<div class="col-sm-2">
						<input type="text" name="subj" id="subj" value="${product.p_subj}">
					</div>
				</div>
				<hr>
				<div>
				...
				<div>
					...
					<input name="addr" type="text" id="sample4_roadAddress"
						placeholder="도로명주소" readOnly style="width: 325px" value="${product.p_addr}">
					<script>
				...
				<div class="form-group row">
					<label class="col-sm-1">가격</label> <input type="text" id="price"
						name="price" placeholder="가격" value="${product.p_price}"> 원
				</div>
				<hr>
				<div class="form-group row">
					...
					<div class="col-sm-2">
						<textarea rows="8" cols="100" style="resize: none"
							placeholder="내용을 입력하세요" id="content" name="content">${product.p_content}</textarea>
						<div id="test_cnt"></div>
					</div>
				</div>
				<hr>
