								...
								<table id=buylist>
									...
									<tbody>
										...
										<c:forEach var="item" items="${requestScope.selllist}">
											<tr>
												<td class="sell_num"><c:out value="${item.sell_num}" />
												</td>
												<td class="cart-pic"
													onclick="location.href='${pageContext.request.contextPath}/productdetail.do?p_num=${item.p_num}&storename=${itme.storename_seller}'">
													<img
												...
												<td class="date"><c:out value="${item.sell_date}" /></td>
